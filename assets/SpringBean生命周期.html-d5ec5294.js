...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="实例化-instantiation" tabindex="-1"><a class="header-anchor" href="#实例化-instantiation" aria-hidden="true">#</a> 实例化（Instantiation）</h2><p>在Spring框架中，实例化（Instantiation）是指创建Bean实例的过程。当Spring容器启动时，它会根据配置文件或注解的定义，实例化所需的Bean对象。</p><p>实例化过程可以通过以下几种方式进行：</p><ol><li><p>构造函数实例化：通过调用Bean类的构造函数来创建Bean实例。可以使用无参构造函数或带参数的构造函数，Spring容器会根据配置文件或注解中的定义来确定使用哪个构造函数进行实例化。</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token annotation punctuation">@Configuration</span>

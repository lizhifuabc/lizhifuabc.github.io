import{_ as n,o as s,c as a,e}from"./app-def54fd2.js";const t="/assets/image-20240320092527345-99b096ef.png",p={},l=e('<h1 id="mybatis自定义类型处理器typehandler" tabindex="-1"><a class="header-anchor" href="#mybatis自定义类型处理器typehandler" aria-hidden="true">#</a> MyBatis自定义类型处理器TypeHandler</h1><p><img src="'+t+`" alt="image-20240320092527345"></p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">TypeHandler</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token class-name">T</span><span class="token punctuation">&gt;</span></span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li><li><p>在springboot的yml配置文件中设置类型处理器所在的<strong>包名</strong>，不是处理器路径（应用到<strong>全局</strong>）</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">mybatis-plus</span><span class="token punctuation">:</span>
